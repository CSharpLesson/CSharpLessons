...
namespace Statics
{
    class Program
    {
        //MyMethod() это название метода
        //staticявляется «модификатором доступа» и определяет видимость метода. Вы узнаете больше о модификаторах доступа позже в этом уроке.
